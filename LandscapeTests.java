...
public class LandscapeTests {
    ...
    public static void landscapeTests() {
        ...
        // case 3: testing getCols()
        {
            ...
            // test
            assert l1.getCols() == 2 : "Error in Landscape::getCols()";
        ...
        // case 5: testing reset()
        {
            ...
            assert total2 == 1 : "Error in Landscape::reset()";
        ...
        // case 6: testing getNeighbors()
        {
            ...
            // test
            assert n1.size() == 1 : "Error in Landscape::getNeighbors(int, int)";
            assert n2.size() == 1 : "Error in Landscape::getNeighbors(int, int)";
